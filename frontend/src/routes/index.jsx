...
const InventoryOverviewPage = lazy(() => import('../pages/inventory/InventoryOverviewPage.jsx'));

// Lazy-loaded Warehouses
const WarehousesListPage = lazy(() => import('../pages/warehouses/WarehousesListPage.jsx'));
const WarehouseFormPage = lazy(() => import('../pages/warehouses/WarehouseFormPage.jsx'));

// Lazy-loaded Purchase Orders
const PurchaseOrdersListPage = lazy(() => import('../pages/purchase-orders/PurchaseOrdersListPage.jsx'));
const PurchaseOrderFormPage = lazy(() => import('../pages/purchase-orders/PurchaseOrderFormPage.jsx'));
const PurchaseOrderDetailPage = lazy(() => import('../pages/purchase-orders/PurchaseOrderDetailPage.jsx'));

// Lazy-loaded Settings
const SettingsPage = lazy(() => import('../pages/settings/SettingsPage.jsx'));
const CustomersSettingsPage = lazy(() => import('../pages/settings/CustomersSettingsPage.jsx'));
...
const SalesReportPage = lazy(() => import('../pages/reports/SalesReportPage.jsx'));
const OrderHistoryPage = lazy(() => import('../pages/reports/OrderHistoryPage.jsx'));
const ProductsReportPage = lazy(() => import('../pages/reports/ProductsReportPage.jsx'));
const InventoryReportPage = lazy(() => import('../pages/reports/InventoryReportPage.jsx'));
