      ...
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            Created on {formatDateOnly(order.createdAt)}
          </p>
        </div>
                ...
                {order.items?.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ textAlign: "right", padding: "16px 0" }}>
                        Rp{" "}
                        {parseFloat(item.unitCost || 0).toLocaleString("id-ID")}
                      </td>
                      <td
                        style={{
                          textAlign: "right",
        ...
        <div>
          ...
          <div className="card" style={{ marginTop: "16px" }}>
            ...
            >
              ...
              <span>
                Rp {parseFloat(order.subtotal || 0).toLocaleString("id-ID")}
              </span>
            </div>
            {order.taxAmount > 0 && (
              <div
              ...
              >
                ...
                <span>
                  Rp {parseFloat(order.taxAmount || 0).toLocaleString("id-ID")}
                </span>
              </div>
            )}
            {order.shippingCost > 0 && (
              ...
              >
                ...
                <span>
                  Rp{" "}
                  {parseFloat(order.shippingCost || 0).toLocaleString("id-ID")}
                </span>
              </div>
            )}
            <div
