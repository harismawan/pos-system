...
function InventoryReportPage() {
    ...
    const filteredItems = showLowStock ? items.filter(i => i.isLowStock) : items;
    ...
    const columns = useMemo(() => [
        {
            ...
            cell: row => (
                <div>
                    ...
                    <div style={{ fontSize: '12px', color: 'var(--gray-400)' }}>{row.product.sku}</div>
                </div>
            ),
        },
        {
        ...
        <div className="page-container">
            ...
            <div className="filter-bar">
                <div className="form-group" style={{ marginBottom: 0 }}>
                    <label className="form-label" style={{ marginBottom: '4px' }}>Warehouse</label>
                    <select
                ...
                <>
                    <div className="stats-grid" style={{ marginBottom: '24px' }}>
                        ...
                        <div className="stat-card">
                            ...
                            <div className="stat-value">Rp {(summary?.totalCostValue || 0).toLocaleString('id-ID')}</div>
                        </div>
                        <div className="stat-card">
                    ...
                    {summary?.lowStockCount > 0 && (
                        <div style={{
                            ...
                            <div>
                                <strong style={{ color: 'var(--warning-600)' }}>{summary.lowStockCount} items</strong> are below minimum stock level
                            </div>
                        </div>
                    )}
