  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        width: "140px",
        cell: (row) => (
          <span style={{ color: "var(--gray-700)" }}>{row.phone || "-"}</span>
        ),
      },
      {
        name: "Role",
      ...
      },
      {
        ...
        cell: (row) => (
          <span style={{ color: "var(--gray-600)", fontSize: "13px" }}>
            {row.outletUsers?.length || 0} outlet
            {row.outletUsers?.length !== 1 ? "s" : ""}
          </span>
        ),
      },
      {
              ...
              <div className="modal-body">
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    style={
                      editingUser ? { backgroundColor: "var(--gray-100)" } : {}
                    }
                  />
                  {getFormError("username") && (
                    <p className="form-error">{getFormError("username")}</p>
                  )}
                  {editingUser && (
                    <p className="form-helper">Username cannot be changed</p>
                  )}
                </div>
                ...
                <div className="form-group">
                  ...
                  {getFormError("password") && (
                    <p className="form-error">{getFormError("password")}</p>
                  )}
                </div>
