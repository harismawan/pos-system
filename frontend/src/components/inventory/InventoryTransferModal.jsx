                ...
                >
                  <div className="form-group" style={{ marginBottom: 0 }}>
                    ...
                    <select
                      ...
                      style={{
                        borderColor: errors.fromWarehouseId
                          ? "var(--error-500)"
                          : undefined,
                    ...
                    {errors.fromWarehouseId && (
                      <p className="form-error">{errors.fromWarehouseId}</p>
                    )}
                  </div>
                  ...
                  <div className="form-group" style={{ marginBottom: 0 }}>
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      style={{
                        borderColor: errors.toWarehouseId
                          ? "var(--error-500)"
                          : undefined,
                      }}
                    >
                    ...
                    {errors.toWarehouseId && (
                      <p className="form-error">{errors.toWarehouseId}</p>
                    )}
                  </div>
                </div>
