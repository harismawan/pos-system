...
function InventoryDetailModal({ isOpen, onClose, inventoryItem }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: (row) => {
        const isPositive =
          ["PURCHASE", "ADJUSTMENT_IN"].includes(row.type) ||
          (row.type === "TRANSFER" &&
            row.toWarehouseId === inventoryItem.warehouse.id);
        return (
          <span
            style={{
        ...
        <div className="modal-body">
          ...
          >
            <div>
              ...
              >
                {parseFloat(inventoryItem.quantityOnHand)}{" "}
                <span
                  style={{
                    fontSize: "14px",
                    fontWeight: 500,
            ...
            <div>
              ...
              >
                ...
                {(
                  parseFloat(inventoryItem.quantityOnHand) *
                  parseFloat(inventoryItem.product?.costPrice || 0)
