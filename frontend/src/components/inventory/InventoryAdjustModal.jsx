...
function InventoryAdjustModal({ isOpen, onClose, onSuccess, preselectedProductId, preselectedWarehouseId }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await inventoryApi.adjustInventory({
                ...
                type: formData.adjustmentType === 'subtract' ? 'ADJUSTMENT_OUT' : 'ADJUSTMENT_IN',
                quantity: quantity,
            ...
            <div className="modal" style={{ maxWidth: '600px' }} onClick={(e) => e.stopPropagation()}>
                ...
                <form onSubmit={handleSubmit}>
                            ...
                            <>
                                ...
                                <div className="form-group">
                                    ...
                                    <select
                                        ...
                                        style={{
                                            borderColor: errors.warehouseId ? 'var(--error-500)' : undefined,
                                ...
                                <div className="form-group">
                                    ...
                                    <div style={{ display: 'flex', gap: '16px' }}>
                                        <label style={{
                                            ...
                                            border: formData.adjustmentType === 'add' ? '2px solid var(--success-500)' : '1px solid var(--gray-300)',
                                            backgroundColor: formData.adjustmentType === 'add' ? 'var(--success-50)' : 'white',
                                            cursor: 'pointer',
                                            flex: 1,
                                            ...
                                            <span style={{ fontWeight: 500, color: 'var(--success-600)' }}>Add Stock</span>
                                        </label>
                                        <label style={{
                                            display: 'flex',
                                            alignItems: 'center',
                                            ...
                                            padding: '12px 20px',
                                            borderRadius: 'var(--radius-lg)',
                                            border: formData.adjustmentType === 'subtract' ? '2px solid var(--error-500)' : '1px solid var(--gray-300)',
                                            backgroundColor: formData.adjustmentType === 'subtract' ? 'var(--error-50)' : 'white',
                                            cursor: 'pointer',
                                            flex: 1,
                                            justifyContent: 'center',
                                            transition: 'all var(--transition-fast)',
                                            ...
                                            />
                                            <span style={{ fontSize: '20px' }}>➖</span>
                                            <span style={{ fontWeight: 500, color: 'var(--error-600)' }}>Remove Stock</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div className="form-group">
                                    ...
                                    <textarea
                                        ...
                                        rows={2}
                                    />
                                    <p className="form-helper">Provide a reason for this adjustment for audit purposes</p>
                                </div>
                            </>
                        )}
                    </div>
                    ...
                    <div className="modal-footer">
                        ...
                        <button
                            type="submit"
                            className={formData.adjustmentType === 'subtract' ? 'btn-danger' : 'btn-success'}
                        ...
                        >
                            ...
                            ) : formData.adjustmentType === 'subtract' ? 'Remove Stock' : 'Add Stock'}
                        </button>
                    </div>
                </form>
            </div>
