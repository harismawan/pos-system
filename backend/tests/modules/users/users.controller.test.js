...
describe("modules/users/users.controller", () => {
  beforeEach(() => {
    ...
    serviceMock.createUser.mockResolvedValue({
      id: "u1",
      name: "Test",
      username: "test",
      role: "ADMIN",
  ...
  it("returns error when list users fails", async () => {
    const set = {};
    serviceMock.getUsers.mockImplementation(async () => {
  ...
  it("returns error when create fails", async () => {
    ...
    err.statusCode = 409;
    serviceMock.createUser.mockImplementation(async () => {
      throw err;
    });
  ...
  it("returns error when update fails", async () => {
    const set = {};
    serviceMock.updateUser.mockImplementation(async () => {
  ...
  it("returns error when delete fails", async () => {
    const set = {};
    serviceMock.deleteUser.mockImplementation(async () => {
      throw new Error("fail");
    });
