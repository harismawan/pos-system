...
mock.module('../../../src/modules/warehouses/warehouses.service.js', () => serviceMock);
mock.module('../../../src/libs/logger.js', () => ({ default: loggerMock }));

const controller = await import('../../../src/modules/warehouses/warehouses.controller.js');

describe('modules/warehouses/warehouses.controller', () => {
    beforeEach(() => {
        serviceMock.getWarehouses.mockReset();
        serviceMock.getWarehouses.mockResolvedValue({ warehouses: [], pagination: {} });
        ...
        serviceMock.updateWarehouse.mockResolvedValue({ id: 'w1', name: 'Updated' });
    ...
    it('returns error when list warehouses fails', async () => {
        const set = {};
        serviceMock.getWarehouses.mockImplementation(async () => { throw new Error('fail'); });
    ...
    it('returns warehouse by id', async () => {
        const set = {};
        const res = await controller.getWarehouseByIdController({ params: { id: 'w1' }, set });
    ...
    it('sets 404 when warehouse not found', async () => {
        const set = {};
        serviceMock.getWarehouseById.mockImplementation(async () => { throw new Error('Warehouse not found'); });

        const res = await controller.getWarehouseByIdController({ params: { id: 'missing' }, set });
    ...
    it('uses provided status when get by id fails', async () => {
        ...
        err.statusCode = 410;
        serviceMock.getWarehouseById.mockImplementation(async () => { throw err; });
    ...
    it('sets 201 on create warehouse', async () => {
        ...
        const res = await controller.createWarehouseController({ body: {}, store, set });
    ...
    it('returns error when create fails with custom status', async () => {
        ...
        err.statusCode = 422;
        serviceMock.createWarehouse.mockImplementation(async () => { throw err; });
    ...
    it('updates warehouse', async () => {
        const set = {};
        const store = { user: { id: 'u1' } };
        const res = await controller.updateWarehouseController({ params: { id: 'w1' }, body: { name: 'New' }, store, set });
    ...
    it('returns error when update fails', async () => {
        const set = {};
        serviceMock.updateWarehouse.mockImplementation(async () => { throw new Error('fail'); });

        const res = await controller.updateWarehouseController({ params: { id: 'w1' }, body: {}, store: { user: { id: 'u1' } }, set });
        expect(set.status).toBe(500);
        expect(res.error).toBe('Internal Server Error');
    });
    ...
    it('deletes warehouse', async () => {
        const set = {};
        const res = await controller.deleteWarehouseController({ params: { id: 'w1' }, set });
    ...
    it('returns error when delete fails', async () => {
        ...
        err.statusCode = 409;
        serviceMock.deleteWarehouse.mockImplementation(async () => { throw err; });
    ...
    it('gets warehouse inventory', async () => {
        const set = {};
        const res = await controller.getWarehouseInventoryController({ params: { id: 'w1' }, query: { lowStock: true }, set });
    ...
    it('returns error when get inventory fails', async () => {
        const set = {};
        serviceMock.getWarehouseInventory.mockImplementation(async () => { throw new Error('boom'); });

        const res = await controller.getWarehouseInventoryController({ params: { id: 'w1' }, query: {}, set });
        expect(set.status).toBe(500);
        expect(res.error).toBe('Internal Server Error');
    });
});
