...
const controller =
  await import("../../../src/modules/pricing/pricing.controller.js");
...
describe("modules/pricing/pricing.controller", () => {
  ...
  it("handles price tier creation errors", async () => {
    const set = {};
    serviceMock.createPriceTier.mockImplementation(async () => {
  ...
  it("handles update price tier errors", async () => {
    const set = {};
    serviceMock.updatePriceTier.mockImplementation(async () => {
      throw new Error("fail");
    });
  ...
  it("handles product prices errors", async () => {
    const set = {};
    serviceMock.getProductPrices.mockImplementation(async () => {
      throw new Error("db");
    });
  ...
  it("handles set product price errors", async () => {
    const set = {};
    serviceMock.setProductPrice.mockImplementation(async () => {
      throw new Error("fail");
    });
