...
export function buildConfig(env = process.env) {
    return {
        ...
        database: {
            ...
            connectionTimeoutMillis: parseInt(env.DATABASE_CONNECTION_TIMEOUT || '10000', 10),
        },
        ...
        jwt: {
            ...
            refreshSecret: env.REFRESH_TOKEN_SECRET || 'change-this-refresh-secret-in-production',
