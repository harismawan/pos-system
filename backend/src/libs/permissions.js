...
export const PERMISSIONS = {
  ...
  // Super Admin (platform-level) - exclusive to SUPER_ADMIN role
...
export const ROLE_PERMISSIONS = {
  SUPER_ADMIN: [
    // Platform-level admin with full access to everything
    ...Object.values(PERMISSIONS),
  ],

  OWNER: [
    // Full access to everything within their business (except platform-level)
