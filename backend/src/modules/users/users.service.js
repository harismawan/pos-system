 ...
 * Create a new user
 */
export async function createUser({ name, username, email, phone, password, role }) {
 ...
 */
export async function updateUser(id, { name, email, phone, role, isActive, password }) {
    // Check user exists
 ...
 */
export async function assignUserToOutlet(userId, outletId, outletRole, isDefault = false) {
